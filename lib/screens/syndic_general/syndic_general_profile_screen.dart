...
class _C {
  static const coral      = Color(0xFFFF6F4A);
...
class SyndicGeneralProfileScreen extends StatefulWidget {
  final int residenceId;
  final int syndicId;

  const SyndicGeneralProfileScreen({
    super.key,
  ...
  @override
  State<SyndicGeneralProfileScreen> createState() =>
      _SyndicGeneralProfileScreenState();
}

class _SyndicGeneralProfileScreenState extends State<SyndicGeneralProfileScreen>
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      _showSnack('Erreur lors du chargement du profil');
    } finally {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      ...
      body: Stack(
        children: [
          // ── Background Image avec Flou augmenté ──
          Positioned.fill(
            child: ImageFiltered(
              imageFilter: ImageFilter.blur(sigmaX: 8, sigmaY: 8), // Flou appliqué à toute l'image
              child: Image.asset(
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Colors.black.withOpacity(0.5), // Augmentation de l'obscurité pour la clarté
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: const Text('Syndic Général',
                style: TextStyle(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFFFF6F4A), Color(0xFFFF8C42)],
                ),
                borderRadius: BorderRadius.circular(14),
                boxShadow: [
                  BoxShadow(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          if (enabled) const Icon(Icons.edit_rounded, size: 14, color: _C.coral),
        ],
      ),
    );
  }
