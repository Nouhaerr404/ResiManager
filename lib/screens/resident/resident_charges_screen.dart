...
class _ResidentChargesScreenState extends State<ResidentChargesScreen> {
                ...
                if (filteredDeps.isEmpty)
                  Center(
                    child: Padding(
                      ...
                      child: Column(children: [
                        ...
                        Text('Aucune dépense pour ce mandat',
                  ...
                  SingleChildScrollView(
                    ...
                    child: Container(
                      ...
                      child: Column(children: [
                        _buildTableHeader(),
                        ...filteredDeps.asMap().entries
                            .map((e) => _buildTableRow(e.value, e.key)),
                        _buildTableFooter(
                            ((data['total'] as num?) ?? 0).toInt()),
                      ]),
                    ),
                  ),
              ],
            ...
            return ListTile(
              leading: Container(
                ...
                child: Icon(
                  ...
                  color: enCours ? Colors.green : _coral, size: 18,
                ),
              ),
              title: Text(m['label'],
                  style: TextStyle(
                      fontWeight: FontWeight.w600,
                      color: isSel ? _coral : _dark)),
              subtitle: Text(
  ...
  Widget _porteeChip(String label) {
    bool isSel = _filterPortee == label;
    return Padding(
      padding: const EdgeInsets.only(right: 8),
      child: GestureDetector(
        onTap: () => setState(() => _filterPortee = label),
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 200),
  ...
  Widget _buildTableHeader() {
    return Container(
      ...
      child: Row(children: const [
        Expanded(flex: 1, child: Text('TYPE', style: TextStyle(
            color: Colors.white70, fontSize: 10,
            fontWeight: FontWeight.bold, letterSpacing: 1))),
        Expanded(flex: 3, child: Text('DESCRIPTION', style: TextStyle(
            color: Colors.white70, fontSize: 10,
            fontWeight: FontWeight.bold, letterSpacing: 1))),
        Expanded(flex: 2, child: Text('PORTÉE', textAlign: TextAlign.center,
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(flex: 2, child: _badge(
            isCommune ? 'Commune' : 'Individuelle',
            isCommune
                ? const Color(0xFF7C5CBF)
