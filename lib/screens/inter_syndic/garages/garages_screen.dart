...
// -- Brand palette (updated to match image design)
class _C {
  static const mint        = Color(0xFF4CAF82);   // primary green (buttons, badges, accents)
  static const mintLight   = Color(0xFFE8F5EE);   // light green chip bg
  static const mintMid     = Color(0xFFB2EADA);
  static const coral       = Color(0xFFFF6B4A);
  static const coralLight  = Color(0xFFFFEDE9);
  static const cream       = Color(0xFFF4F6F8);   // page background (light neutral grey)
  static const dark        = Color(0xFF1C1C1E);   // primary dark text
  static const gray        = Color(0xFF718096);   // secondary text
  static const divider     = Color(0xFFE2E8F0);   // borders & dividers
            ...
            child: Column(
              ...
              children: [
                _dialogHeader(ctx, 'Ajouter Garage',
                    icon: Icons.garage_rounded, iconColor: _C.mint),
                const SizedBox(height: 20),
